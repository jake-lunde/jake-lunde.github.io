...
function getRandomWord() {
  ...
  // Ensure we haven't used this word before
...
function calculateDifficulty(word1, word2) {
    ...
    // Debugging logs:
    console.log("Index of '" + word1 + "':", index1);
    console.log("Index of '" + word2 + "':", index2);

    const difficulty = Math.abs(index2 - index1);
    
    console.log("Computed Difficulty:", difficulty);
